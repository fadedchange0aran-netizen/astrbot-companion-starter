...
def get_settings() -> Settings:
    ...
    astrbot_attachments_dir = Path(
        _env_str("ARAN_ASTRBOT_ATTACHMENTS_DIR", str(BASE_DIR / "data" / "astrbot" / "attachments"))
    ).expanduser()
    astrbot_data_db_path = Path(
    ...
    qq_chat_backup_root = Path(
        _env_str("ARAN_QQ_CHAT_BACKUP_ROOT", str(BASE_DIR / "data" / "astrbot" / "qq_chat_backups"))
    ).expanduser()
    ...
    return Settings(
        ...
        astrbot_username=_env_str("ARAN_ASTRBOT_USERNAME", "owner").strip() or "owner",
        astrbot_config_id=_env_str("ARAN_ASTRBOT_CONFIG_ID", "").strip(),
        astrbot_bot_id=_env_str("ARAN_ASTRBOT_BOT_ID", "companion").strip() or "companion",
        astrbot_platform=_env_str("ARAN_ASTRBOT_PLATFORM", "companion_bridge").strip() or "companion_bridge",
